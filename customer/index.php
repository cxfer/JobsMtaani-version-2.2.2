                ...
                <div class="row">
                    <div class="col-md-6 mb-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <p class="text-muted">Your recent booking activities will be displayed here.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 mb-4">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="mb-0">Favorite Services</h5>
                            </div>
                            <div class="card-body">
                                <p class="text-muted">Your favorite services will be displayed here.</p>
                            </div>
                        </div>
                    </div>
                </div>
