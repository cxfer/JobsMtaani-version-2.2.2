...
<head>
    ...
    <style>
        ...
        * {
        ...
        .status-in-progress {
            background: var(--ultimate-accent-100);
            color: var(--ultimate-accent-800);
        }

        /* Reviews */
        .rating-stars i {
            color: var(--ultimate-warning-400);
        }
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-4">
                                    ...
                                    <div>
                                        <h5 class="mb-0"><?php echo number_format($avg_rating, 1); ?> ★</h5>
                                ...
                                <div class="d-flex align-items-center mb-4">
                                    ...
                                    <div>
                                        <h5 class="mb-0"><?php echo $total_reviews; ?></h5>
