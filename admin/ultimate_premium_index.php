...
<head>
    ...
    <style>
        ...
        * {
        ...
        .activity-item {
            display: flex;
            padding: var(--ultimate-spacing-4) 0;
                        ...
                        <div class="chart-container">
                            ...
                            <div class="chart-placeholder bg-light rounded d-flex align-items-center justify-content-center" style="height: 300px;">
                                <div class="text-center">
                                    ...
                                    <p class="text-muted">Platform performance metrics visualization</p>
                        ...
                        <div class="chart-container">
                            ...
                            <ul class="activity-list">
                                ...
                                <li class="activity-item">
                                    ...
                                    <div class="activity-content">
                                        <h4 class="activity-title">New service added</h4>
                                ...
                                <li class="activity-item">
                                    ...
                                    <div class="activity-content">
                                        <h4 class="activity-title">Booking confirmed</h4>
                                ...
                                <li class="activity-item">
                                    ...
                                    <div class="activity-content">
                                        <h4 class="activity-title">New review submitted</h4>
                                ...
                                <li class="activity-item">
                                    ...
                                    <div class="activity-content">
                                        <h4 class="activity-title">System alert</h4>
